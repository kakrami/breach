...
function handleShellState(state){
  ...
  if(state.location==='menu'&&!document.hidden)startIntroMusic();else stopIntroMusic();
}
...
function bindUI(){
  ...
  $('fullBtn').addEventListener('click',()=>{ensureAudio();void shell.toggleFullscreenFromGesture();});
